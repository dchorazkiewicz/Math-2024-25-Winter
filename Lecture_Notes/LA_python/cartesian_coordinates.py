...
def cart_not_ortogonal():
    ...
    transformed_points = {
        label: transform_point(coords, basis_vector_1, basis_vector_2)
    ...
    # Matematyczny tytuł wykresu
    plt.title(
        "Non-Orthogonal Coordinate System with Transformed Points and Basis Lines"
    )
    ...
    for i in range(-10, 11):
        ...
        plt.plot(
            [
                i * basis_vector_1[0] - 20 * basis_vector_2[0],
                i * basis_vector_1[0] + 20 * basis_vector_2[0],
            ],
            [
                i * basis_vector_1[1] - 20 * basis_vector_2[1],
                i * basis_vector_1[1] + 20 * basis_vector_2[1],
            ],
            "b--",
            linewidth=0.5,
        ...
        plt.plot(
            [
                i * basis_vector_2[0] - 20 * basis_vector_1[0],
                i * basis_vector_2[0] + 20 * basis_vector_1[0],
            ],
            [
                i * basis_vector_2[1] - 20 * basis_vector_1[1],
                i * basis_vector_2[1] + 20 * basis_vector_1[1],
            ],
            "r--",
            linewidth=0.5,
